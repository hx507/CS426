...
entry:
	...
	%tmp.8 = getelementptr %_Int_vtable, %_Int_vtable* %tmp.7, i32 0, i32 6
	%tmp.9 = load %Int* (%Int*) *, %Int* (%Int*) ** %tmp.8
	%tmp.10 = call %Int*(%Int* ) %tmp.9( %Int* %tmp.5 )
	%tmp.12 = getelementptr %Int, %Int* %tmp.10, i32 0, i32 1
	%tmp.11 = load i32, i32* %tmp.12
	store i32 %tmp.11, i32* %tmp.2
