...
@str.0 = internal constant [11 x i8] c"minus_o.cl\00"
...
entry:
	...
	%tmp.5 = getelementptr %Main, %Main* %tmp.4, i32 0, i32 2
	%tmp.6 = load i32, i32* %tmp.5
	%tmp.7 = sub i32 %tmp.3, %tmp.6
...
ok.0:
	...
	%tmp.16 = bitcast %Main* %tmp.15 to %Object*
	ret %Object* %tmp.16
...
okay:
	...
	%tmp.23 = getelementptr %Main, %Main* %tmp.21, i32 0, i32 1
	store i32 0, i32* %tmp.23
	%tmp.24 = getelementptr %Main, %Main* %tmp.21, i32 0, i32 2
	store i32 0, i32* %tmp.24
	%tmp.25 = getelementptr %Main, %Main* %tmp.21, i32 0, i32 1
	store i32 10, i32* %tmp.25
	%tmp.26 = getelementptr %Main, %Main* %tmp.21, i32 0, i32 2
	store i32 30, i32* %tmp.26
	ret %Main* %tmp.21
