...
.Lfunc_end2:
	...
	.cfi_endproc
                                        # -- End function
	.globl	A.getGreetings                  # -- Begin function A.getGreetings
	.p2align	4, 0x90
	.type	A.getGreetings,@function
A.getGreetings:                         # @A.getGreetings
	.cfi_startproc
# %bb.0:                                # %entry
	movq	%rdi, -8(%rsp)
	movq	8(%rdi), %rax
	retq
.Lfunc_end3:
	.size	A.getGreetings, .Lfunc_end3-A.getGreetings
	.cfi_endproc
                                        # -- End function
