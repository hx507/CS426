...
.Lfunc_end0:
	...
	.cfi_endproc
                                        # -- End function
	.globl	Alpha.getSelf                   # -- Begin function Alpha.getSelf
	.p2align	4, 0x90
	.type	Alpha.getSelf,@function
Alpha.getSelf:                          # @Alpha.getSelf
	.cfi_startproc
# %bb.0:                                # %entry
	movq	%rdi, %rcx
	movq	%rcx, %rdx
	...
	retq
.Lfunc_end1:
	.size	Alpha.getSelf, .Lfunc_end1-Alpha.getSelf
	.cfi_endproc
                                        # -- End function
...
.LBB2_2:                                # %abort
	...
	callq	abort@PLT
.Lfunc_end2:
	.size	Alpha_new, .Lfunc_end2-Alpha_new
	.cfi_endproc
                                        # -- End function
