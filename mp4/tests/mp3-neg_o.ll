...
@str.0 = internal constant [9 x i8] c"neg_o.cl\00"
...
entry:
	...
	store i32 %tmp.4, i32* %tmp.6
	%tmp.7 = load %Main*, %Main** %tmp.0
	%tmp.8 = getelementptr %Main, %Main* %tmp.7, i32 0, i32 1
