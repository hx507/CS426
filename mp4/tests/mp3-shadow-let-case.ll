...
@str.0 = internal constant [19 x i8] c"shadow-let-case.cl\00"
...
entry:
	...
	%tmp.3 = icmp eq %String* @String.2, null
	br i1 %tmp.3, label %abort, label %ok.0

ok.0:
	%tmp.4 = getelementptr %String, %String* @String.2, i32 0, i32 0
...
ok.2:
	...
	%tmp.21 = getelementptr %_Main_vtable, %_Main_vtable* %tmp.20, i32 0, i32 7
