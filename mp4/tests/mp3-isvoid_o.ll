...
ok.0:
	...
	%tmp.10 = load %_Main_vtable*, %_Main_vtable** %tmp.9
	%tmp.11 = getelementptr %_Main_vtable, %_Main_vtable* %tmp.10, i32 0, i32 11
...
ok.1:
	...
	%tmp.18 = getelementptr %_Main_vtable, %_Main_vtable* %tmp.17, i32 0, i32 7
...
ok.2:
	...
	%tmp.24 = load %_Main_vtable*, %_Main_vtable** %tmp.23
	%tmp.25 = getelementptr %_Main_vtable, %_Main_vtable* %tmp.24, i32 0, i32 7
...
entry:
	%tmp.31 = alloca %Main*
	%tmp.32 = getelementptr %_Main_vtable, %_Main_vtable* @_Main_vtable_prototype, i32 0, i32 1
	%tmp.33 = load i32, i32* %tmp.32
	%tmp.34 = call i8*(i32 ) @malloc( i32 %tmp.33 )
	%tmp.35 = bitcast i8* %tmp.34 to %Main*
	%malloc.null = icmp eq %Main* %tmp.35, null
	br i1 %malloc.null, label %abort, label %okay

okay:
	%tmp.36 = getelementptr %Main, %Main* %tmp.35, i32 0, i32 0
	store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %tmp.36
	store %Main* %tmp.35, %Main** %tmp.31
	%tmp.37 = getelementptr %Main, %Main* %tmp.35, i32 0, i32 1
	store %Main* null, %Main** %tmp.37
	%tmp.38 = getelementptr %Main, %Main* %tmp.35, i32 0, i32 1
	store %Main* null, %Main** %tmp.38
	ret %Main* %tmp.35
