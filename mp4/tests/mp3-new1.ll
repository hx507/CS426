...
entry:
	%tmp.7 = alloca %Main*
	%tmp.8 = getelementptr %_Main_vtable, %_Main_vtable* @_Main_vtable_prototype, i32 0, i32 1
	%tmp.9 = load i32, i32* %tmp.8
	%tmp.10 = call i8*(i32 ) @malloc( i32 %tmp.9 )
	%tmp.11 = bitcast i8* %tmp.10 to %Main*
	%malloc.null = icmp eq %Main* %tmp.11, null
	br i1 %malloc.null, label %abort, label %okay

okay:
	%tmp.12 = getelementptr %Main, %Main* %tmp.11, i32 0, i32 0
	store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %tmp.12
	store %Main* %tmp.11, %Main** %tmp.7
	%tmp.13 = getelementptr %Main, %Main* %tmp.11, i32 0, i32 1
	store i32 0, i32* %tmp.13
	%tmp.14 = getelementptr %Main, %Main* %tmp.11, i32 0, i32 1
	%tmp.15 = call %Int* @Int_new(  )
	%tmp.17 = getelementptr %Int, %Int* %tmp.15, i32 0, i32 1
	%tmp.16 = load i32, i32* %tmp.17
	store i32 %tmp.16, i32* %tmp.14
	ret %Main* %tmp.11
