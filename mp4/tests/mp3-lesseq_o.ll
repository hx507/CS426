...
@str.0 = internal constant [12 x i8] c"lesseq_o.cl\00"
...
ok.0:
	...
	%tmp.9 = load i1 (%Main*) *, i1 (%Main*) ** %tmp.8
	%tmp.10 = call i1(%Main* ) %tmp.9( %Main* %tmp.4 )
	br i1 %tmp.10, label %true.0, label %false.0

true.0:
	%tmp.11 = load %Main*, %Main** %tmp.2
...
ok.1:
	...
	%tmp.17 = call %Main*(%Main*, i32 ) %tmp.16( %Main* %tmp.11, i32 1 )
	store %Main* %tmp.17, %Main** %tmp.3
	br label %end.0

false.0:
	%tmp.18 = load %Main*, %Main** %tmp.2
...
ok.2:
	...
	%tmp.23 = load %Main* (%Main*,i32) *, %Main* (%Main*,i32) ** %tmp.22
	%tmp.24 = call %Main*(%Main*, i32 ) %tmp.23( %Main* %tmp.18, i32 0 )
	store %Main* %tmp.24, %Main** %tmp.3
	br label %end.0

end.0:
	%tmp.25 = load %Main*, %Main** %tmp.3
