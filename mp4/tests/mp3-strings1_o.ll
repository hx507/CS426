...
@str.1 = internal constant [7 x i8] c"Yoyoyo\00"
@String.1 = constant %String {
	%_String_vtable* @_String_vtable_prototype,
	i8* getelementptr ([7 x i8], [7 x i8]* @str.1, i32 0, i32 0)
}

@str.0 = internal constant [14 x i8] c"strings1_o.cl\00"
...
ok.1:
	...
	%tmp.7 = load %String* (%Main*) *, %String* (%Main*) ** %tmp.6
	%tmp.8 = call %String*(%Main* ) %tmp.7( %Main* %tmp.2 )
