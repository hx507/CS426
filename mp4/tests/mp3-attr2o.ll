...
@str.0 = internal constant [10 x i8] c"attr2o.cl\00"
...
entry:
	...
	%tmp.3 = load %Alpha*, %Alpha** %tmp.2
	%tmp.4 = icmp eq %Alpha* %tmp.3, null
	br i1 %tmp.4, label %abort, label %ok.1

ok.1:
	%tmp.5 = getelementptr %Alpha, %Alpha* %tmp.3, i32 0, i32 0
	%tmp.6 = load %_Alpha_vtable*, %_Alpha_vtable** %tmp.5
	%tmp.7 = getelementptr %_Alpha_vtable, %_Alpha_vtable* %tmp.6, i32 0, i32 7
	%tmp.8 = load i32 (%Alpha*) *, i32 (%Alpha*) ** %tmp.7
	%tmp.9 = call i32(%Alpha* ) %tmp.8( %Alpha* %tmp.3 )
...
entry:
	%tmp.19 = alloca %Main*
	%tmp.20 = getelementptr %_Main_vtable, %_Main_vtable* @_Main_vtable_prototype, i32 0, i32 1
	%tmp.21 = load i32, i32* %tmp.20
	%tmp.22 = call i8*(i32 ) @malloc( i32 %tmp.21 )
	%tmp.23 = bitcast i8* %tmp.22 to %Main*
	%malloc.null = icmp eq %Main* %tmp.23, null
	br i1 %malloc.null, label %abort, label %okay

okay:
	%tmp.24 = getelementptr %Main, %Main* %tmp.23, i32 0, i32 0
	store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %tmp.24
	store %Main* %tmp.23, %Main** %tmp.19
	%tmp.25 = getelementptr %Main, %Main* %tmp.23, i32 0, i32 1
	store %Alpha* null, %Alpha** %tmp.25
	%tmp.26 = getelementptr %Main, %Main* %tmp.23, i32 0, i32 1
	%tmp.27 = call %Alpha* @Alpha_new(  )
	store %Alpha* %tmp.27, %Alpha** %tmp.26
	ret %Main* %tmp.23
...
entry:
	...
	%tmp.1 = load %Alpha*, %Alpha** %tmp.0
	%tmp.2 = getelementptr %Alpha, %Alpha* %tmp.1, i32 0, i32 1
...
entry:
	%tmp.4 = alloca %Alpha*
	%tmp.5 = getelementptr %_Alpha_vtable, %_Alpha_vtable* @_Alpha_vtable_prototype, i32 0, i32 1
	%tmp.6 = load i32, i32* %tmp.5
	%tmp.7 = call i8*(i32 ) @malloc( i32 %tmp.6 )
	%tmp.8 = bitcast i8* %tmp.7 to %Alpha*
	%malloc.null = icmp eq %Alpha* %tmp.8, null
	br i1 %malloc.null, label %abort, label %okay

okay:
	%tmp.9 = getelementptr %Alpha, %Alpha* %tmp.8, i32 0, i32 0
	store %_Alpha_vtable* @_Alpha_vtable_prototype, %_Alpha_vtable** %tmp.9
	store %Alpha* %tmp.8, %Alpha** %tmp.4
	%tmp.10 = getelementptr %Alpha, %Alpha* %tmp.8, i32 0, i32 1
	store i32 0, i32* %tmp.10
	%tmp.11 = getelementptr %Alpha, %Alpha* %tmp.8, i32 0, i32 1
	store i32 67, i32* %tmp.11
	ret %Alpha* %tmp.8
